...
> Consignes officielles du projet OpenClassrooms, parcours Data Engineer, reprises ici comme
> document de référence de travail — étapes détaillées comprises.
> [Énoncé du projet](https://openclassrooms.com/fr/paths/1039/projects/1837/assignment) ·
> page mise à jour le 27 juillet 2026 · durée estimée 60 heures.
>
> Note : la version du 5 mai 2026 ne détaillait pas les Étapes 1, 2 et 3 de l'Exercice 1. Celles-ci
> ajoutent quatre exigences à ne pas manquer — entrepôt de données cloud, service d'extension de
> l'Active Directory, chiffrage des coûts par composant, et format de 400 à 1200 mots.
...
> ### Arbitrage AWS ou Redpanda — c'est les deux
